      ...
      const InvoicePDF = (
        <Document>
          <Page size="A4" style={styles.page}>
            <Text style={styles.headerText}>TAX INVOICE <Text style={styles.originalCopy}>ORIGINAL FOR RECIPIENT</Text></Text>
            ...
            <Image src="/images/Aavkar3.png" style={styles.logo} />
              ...
              <View style={styles.companyInfo}>
                ...
                <Text>
                  Mobile: {companyDetails.mobile} GSTIN: {companyDetails.gstin} PAN Number: {companyDetails.pan}
                </Text>
            ...
            <View style={styles.table}>
              ...
              {order.products.map((product: any, index: number) => (
                <View key={index} style={styles.tableRow}>
                  <Text style={[styles.cell, styles.itemCol]}>Designer Kurti</Text>
                  <Text style={[styles.cell, styles.hsnCol]}>6404</Text>
                  <Text style={[styles.cell, styles.qtyCol]}>2 PCS</Text>
                  <Text style={[styles.cell, styles.rateCol]}>&#8377; Rs. 2750</Text>
                  <Text style={[styles.cell, styles.taxCol]}>&#8377; 1650</Text>
                  <Text style={[styles.cell, styles.amountCol]}>&#8377; 15400</Text>
            ...
            <View style={styles.termsSection}>
              ...
              <Text>1. Payment should be made by NEFT/RTGS/ cheque wire transfer only.</Text>
              <Text>
                2. no GR will be accepted any quality concern must be raised within 24 hours after receiving goods after
                that no complaint will be entertained.
              </Text>
              <Text>3. penalty & interest 24% per annual will be changed after the due date.</Text>
              <Text>4. we are not responsible for any loss /demage during transit or logistics.</Text>
              <Text>
                5. logistics costs all costs transportation and delivery are to be paid by the customer/buyer.
              </Text>
            </View>
